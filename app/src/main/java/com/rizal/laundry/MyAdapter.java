                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        switch (i){
                            ...
                            case 2 :
                                ...
                                builderDel.setMessage("Anda Yakin Ingin Menghapus Data Ini?");
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_DELETE, new Response.Listener<String>() {
                                            ...
                                            public void onResponse(String response) {
                                                dialog.hide();
                                                dialog.dismiss();
                                                Toast.makeText(view.getContext(),"Berhasil menghapus data "+ listItem.getName(),Toast.LENGTH_LONG).show();
                                ...
                                builderDel.setNegativeButton("Batal", new DialogInterface.OnClickListener() {
                                    @Override
